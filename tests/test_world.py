...
def test_critter_movement_and_actions(
    ...
    with patch.object(
        world.grid, "move_item_relative", wraps=world.grid.move_item_relative
    ) as move_item:
        with patch.object(
            world.grid, "apply_action", wraps=world.grid.apply_action
        ) as apply_action:
            with patch.object(
                ...
                # make an action
                assert perform_action.called == (move_pos_occupied and is_action)
